Arbiter.Validator = (function() {
  return{
       ...
       /* Make GeoJSON format object and send it to Validator Server */
             ...
             {
               Android.ValidationDoneProgressDialog();
               console.log("Validation result from Validator Server" + result, result);
                ...
                for(var i=0; i<errorResults.length; i++)
                {
                   markingPoints[i] = new OpenLayers.Feature.Vector(
                      new OpenLayers.Geometry.Point(
                           errorResults[i].errorCoordinateX, errorResults[i].errorCoordinateY));
                }
