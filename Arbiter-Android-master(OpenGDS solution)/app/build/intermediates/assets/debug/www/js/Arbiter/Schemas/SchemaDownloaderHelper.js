(function(){
	...
	prototype.checkNotInProject = function(){
		...
		Arbiter.GeometryColumnsHelper.getGeometryColumn(this.layer, context, function(context,layer1,layer2){
			
			// Is in project so don't add this layer.
			console.log("layer is in project, so delete the layer from the project");
			
			// 각 layer 의 feature type 이 같더라도 workspace 가 다르면 db에 저장
			if(layer1.featureType !== layer2.featureType)
