...
public class FindAreaListAdapter extends BaseAdapter implements ArbiterAdapter<SparseArray<Server>>{
    ...
    public FindAreaListAdapter(FragmentActivity activity, int itemLayout,
                             int textId){
