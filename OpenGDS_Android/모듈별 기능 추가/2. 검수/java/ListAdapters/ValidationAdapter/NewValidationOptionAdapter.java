...
public class NewValidationOptionAdapter extends BaseAdapter {
    ...
    public NewValidationOptionAdapter(Context context, DialogFragment dialog, HasThreadPool hasThreadPool, int itemLayout) {
        ...
        optStr = new String[]{
                context.getString(R.string.SmallArea),
                context.getString(R.string.SmallLength),
                context.getString(R.string.EntityDuplicated),
                context.getString(R.string.SelfEntity),
                context.getString(R.string.PointDuplicated),
                context.getString(R.string.ConIntersected),
                context.getString(R.string.ConOverDegree),
                context.getString(R.string.ConBreak),
                context.getString(R.string.ZValueAmbiguous),
                context.getString(R.string.UselessPoint)
        };
